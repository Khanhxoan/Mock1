...
const Questions = () => {
  ...
  const questionList = useSelector(
    (state) => state?.getAmountQuestion.questions?.allQuestions?.results
  );
  ...
  const handleNext = async () => {
    ...
    totalAnswer[index + 1]?.correctanswer
      ...
      >
        <Radio.Group onChange={onChange} value={value}>
          <Space direction="vertical">
            <Radio value={questionList[index].answer1} className="radio-answer">
              {questionList[index].answer1}
            </Radio>
            <Radio value={questionList[index].answer2} className="radio-answer">
              {questionList[index].answer2}
            </Radio>
            <Radio value={questionList[index].answer3} className="radio-answer">
              {questionList[index].answer3}
            </Radio>
            <Radio value={questionList[index].answer4} className="radio-answer">
